...
function(e, t) {
                ...
                return new Promise(function(a, u) {
                    o._requester.sendRequest(o._datafeedUrl, "history", i).then(function(e) {
                        if ("ok" === e.s || "no_data" === e.s) {
                            ...
                            else for (var s = void 0 !== e.v, o = void 0 !== e.o, i = 0; i < e.t.length; ++i) {
                                var n = {
                                    time: 1e3 * e.t[i],
                                    close: Number(e.c[i]),
                                    open: Number(e.c[i]),
    ...
    var t = function() {
            function e(e, t, r) {
                this._exchangesList = ["NYSE", "FOREX", "AMEX"], this._symbolsInfo = {}, this._symbolsList = [], this._datafeedUrl = e, this._datafeedSupportedResolutions = t, this._requester = r, this._readyPromise = this._init(), this._readyPromise.
                catch (function(e) {
